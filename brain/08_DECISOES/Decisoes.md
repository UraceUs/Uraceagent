...
- [[D-2026-09-17 - Fluxo do closer, voz no painel e acesso livre]] — oportunidade não é cliente; fechar venda em uma tela dispara cliente, QuickBooks, waiver, Asana e Kommo (com tarefa personalizada); valor fora da tabela fecha a venda e deixa a invoice para o dono; papel CLOSER só na área de vendas; conta de acesso livre sem cargo; voz (ditar e ouvir) em todo o painel; fuso da Flórida também no servidor
