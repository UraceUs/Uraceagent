...
export interface Email {
  ...
  triaged_at?: string | null; triage_reason?: string | null; needs_human?: number
  client_name?: string | null; links?: Link[]
}
...
export interface GmailMessage {
  ...
  marcadores: string[] | null; snippet: string | null; corpo?: string; tem_html?: boolean; inline?: number; anexos?: { nome: string; mime: string; attachment_id: string | null; bytes: number | null }[] | null
}
...
export interface AutomationRule { id: number; name: string; enabled: number; trigger: string; conditions: string | null; actions: string; created_at: string; schedule?: string | null; last_run_at?: string | null; last_result?: string | null }
...
export interface Race { id: number; name: string; series: string | null; track: string | null; city: string | null; date_start: string | null; date_end: string | null; notes: string | null; source: string | null; active: number; invites: number
  task_id?: number | null; task?: { id: number; title: string; status: string; due_on: string | null; section: string | null; subtasks_total: number | null; subtasks_done: number | null; assignee: string | null; links?: Link[] } | null
