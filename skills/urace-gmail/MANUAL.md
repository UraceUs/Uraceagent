...
3. **Nada de apagar e nada de spam.** Arquivar (tirar da inbox), só com marcador CONFIRMADO no painel — `wNews` inclusive. O que não está no manual confirmado fica na inbox (dono, 22/09).
